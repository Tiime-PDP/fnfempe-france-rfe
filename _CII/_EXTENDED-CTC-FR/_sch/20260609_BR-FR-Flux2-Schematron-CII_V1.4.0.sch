...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
  ...
  <pattern id="BR-FR-08">
    ...
    <rule context="rsm:CrossIndustryInvoice/rsm:ExchangedDocumentContext/ram:BusinessProcessSpecifiedDocumentContextParameter">
      <assert test="custom:is-valid-billing-mode(ram:ID) and exists(ram:ID)"
        flag="warning" id="BR-FR-08_BT-23">
        BR-FR-08/BT-23 : La valeur du mode de facturation (ram:ID) est absente ou n’est pas autorisée. Valeurs acceptées : B1, S1, M1, B2, S2, M2, B4, S4, M4, S5, S6, B7, S7, B8, S8, M8, B9, S9, M9.
        Valeur actuelle : "<value-of select="."/>".
  ...
  <pattern id="BR-FR-31">
    ...
    <rule context="rsm:CrossIndustryInvoice/rsm:ExchangedDocument">
      ...
      <assert test="$barCount &lt;= 1" flag="warning" id="BR-FR-31_BT-21">
  ...
  <pattern id="BR-FR-32">
    ...
    <rule context="//ram:GlobalID[@schemeID = '0002' or @schemeID='0231']">
      ...
      <assert test="matches(normalize-space(.), '^\d{9}$')" flag="warning" id="BR-FR-32-GLOBALID">
  ...
  <pattern id="BR-FR-DEC-03"> <!-- V1.4 : les PU euvent être négatifs si Bi-directionnel -->
    ...
    <rule context="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeAgreement/ram:NetPriceProductTradePrice/ram:ChargeAmount">
      <let name="amount" value="normalize-space(.)"/>
      <assert test="(custom:isSpecialContractBD(/rsm:CrossIndustryInvoice) and custom:is-valid-decimal-19-6($amount)) or (not(custom:isSpecialContractBD(/rsm:CrossIndustryInvoice)) and custom:is-valid-decimal-19-6-positive($amount))" flag="warning" id="BR-FR-DEC-03_BT-146">
    ...
    <rule context="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeAgreement/ram:GrossPriceProductTradePrice/ram:AppliedTradeAllowanceCharge/ram:ActualAmount">
      <let name="amount" value="normalize-space(.)"/>
      <assert test="(custom:isSpecialContractBD(/rsm:CrossIndustryInvoice) and custom:is-valid-decimal-19-6($amount)) or (not(custom:isSpecialContractBD(/rsm:CrossIndustryInvoice)) and custom:is-valid-decimal-19-6-positive($amount))" flag="warning" id="BR-FR-DEC-03_BT-147">
    ...
    <rule context="rsm:CrossIndustryInvoice/rsm:SupplyChainTradeTransaction/ram:IncludedSupplyChainTradeLineItem/ram:SpecifiedLineTradeAgreement/ram:GrossPriceProductTradePrice/ram:ChargeAmount">
      <let name="amount" value="normalize-space(.)"/>
      <assert test="(custom:isSpecialContractBD(/rsm:CrossIndustryInvoice) and custom:is-valid-decimal-19-6($amount)) or (not(custom:isSpecialContractBD(/rsm:CrossIndustryInvoice)) and custom:is-valid-decimal-19-6-positive($amount))" flag="warning" id="BR-FR-DEC-03_BT-148">
