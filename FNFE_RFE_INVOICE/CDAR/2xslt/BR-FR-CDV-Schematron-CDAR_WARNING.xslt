...
<xsl:stylesheet xmlns:custom="http://www.example.org/custom"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl" title="" schemaVersion="">
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="name">BR-FR-CDV-14 — Vérification de la présence d'un Motif quand nécessaire.</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <!--PATTERN BR-FR-CDV-15BR-FR-CDV-14 — Vérification de la présence d'un Motif quand nécessaire.-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">BR-FR-CDV-14 — Vérification de la présence d'un Motif quand nécessaire.</svrl:text>
   <!--RULE -->
