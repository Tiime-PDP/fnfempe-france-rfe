...
-->
<!-- Schematron 20260216_BR-FR-CDV-Schematron-CDAR_V1.4.0 - last update 2026 05 31 -->
...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
  ...
  <pattern id="BR-FR-CDV-02"> <!-- CYS3 urn.cpro.gouv.fr:1p0:CDV:invoice maintenu pour les échanges entre PA V1.4 : le matricule du PPF est 0000 -->
  ...
  <pattern id="BR-FR-CDV-16"> <!-- VCYS ajout de exists() -->
